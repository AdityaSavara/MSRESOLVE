...
def ReferenceInputPreProcessing(ReferenceData, verbose=True, tuningCorrection=False):
    #typically, TuningCorrection has been done before ReferenceInputPreProcessing. However, as of September 19th 2021, ratio finder callsReferenceInputPreProcessing in advance of when tuningCorrection would normally happen, so we force a tuningCorrection in that case. This also creates a standardized reference pattern.
