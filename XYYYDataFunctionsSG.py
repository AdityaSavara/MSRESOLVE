...
AbscissaValuesToKeep- List of floats. NOTE: AbscissaValuesToKeep is not necessarily 
                      ...
                      in DataAbscissa.
'''
def KeepOnlySelectedYYYYColumns(YYYYData, DataAbscissa, AbscissaValuesToKeep,iterativeAnalysis = False):
    ...
    #if iterative analysis is being performed, then the indicies are needed. 
    if iterativeAnalysis:
        return (YYYYData, DataAbscissa, deletion_indices)
