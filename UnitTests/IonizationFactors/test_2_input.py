...
#USER INPUT FILE
#//Input Files//
referenceFileNamesList = ['AcetaldehydeNISTRefMatchingMolecule.csv'] #enter the file name of the file containing reference information
...
timeRangeLimit = 'no'	#if you wish to enable this function enter 'yes' otherwise 'no'
