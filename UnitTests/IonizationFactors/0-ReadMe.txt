...
The knownIonizationFactorsRelativeToN2 are all set to 'unknown', and the molecule types for CO and CO2 have been populated.  The only type used in the reference file is Main Group.
