...
UserChoices['measuredReferenceYorN']['referenceFileToTune'] ='AcetaldehydeMeasuredRef.csv'
UserChoices['measuredReferenceYorN']['referenceFileToMatch'] ='AcetaldehydeOnlyNISTRef.csv'
