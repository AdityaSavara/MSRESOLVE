...
UserChoices['measuredReferenceYorN']['referenceFileDesiredTuning'] ='AcetaldehydeOnlyNISTRef.csv' #this will be ignored in test_15.py
...
UserChoices['measuredReferenceYorN']['referenceCorrectionCoefficients_cov'] = [0,0,0] #no cov.
