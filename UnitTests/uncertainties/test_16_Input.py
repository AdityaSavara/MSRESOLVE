...
UserChoices['measuredReferenceYorN']['referenceFileExistingTuningAndForm'] = [] #['ReferenceExternal.csv', 'xyxy']
UserChoices['measuredReferenceYorN']['referenceFileDesiredTuningAndForm'] = []
