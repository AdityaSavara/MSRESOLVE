...
UserChoices['measuredReferenceYorN']['referenceFileStandardTuningAndForm'] =  ['LiteratureReference.tsv','xyyy'] #This is the pattern that will be changed. Typically this is NIST patterns.
