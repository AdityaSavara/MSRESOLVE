...
UserChoices['measuredReferenceYorN']['referenceFileStandardTuningandForm'] =  ['LiteratureReference.csv','xyyy'] #This is the pattern that will be changed. Typically this is NIST patterns.
