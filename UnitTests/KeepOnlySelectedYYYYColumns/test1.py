...
DataAbscissa = np.array(['2','18','26','27','28','29','31','39','41','44','45','56','57','70'])
AbscissaValuesToKeep = ['2','18','27','28','31','39','41','44','57','70']

#output
output = KeepOnlySelectedYYYYColumns(YYYYData,DataAbscissa,AbscissaValuesToKeep)
resultObj = output
