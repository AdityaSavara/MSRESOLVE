...
topBestMassFragments= bmfc.bestMassFragChooser(moleculesToMonitor, moleculesLikelihood, numberOfMassFragsToMonitor,'AcetaldehydeNISTRefMixed2.csv','xyyy', onTheFlySLS=True, useExtentOfSLSUniqueSolvable = True)[0] #, output[1], output[2]]  #You can alternatively populate resultObj with whatever you want, such as a list.
