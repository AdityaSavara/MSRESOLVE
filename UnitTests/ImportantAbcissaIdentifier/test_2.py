...
data=numpy.array([[10, 3, 2],
                  [2, 1, 4],
                  [6, 11, 7],
                  [13, 5, 4]])
    
data2=numpy.array([[1, 1, 1],
                  [2, 2, 2],
                  [3, 3, 3],
                  [4, 4, 4]])
    
data3=numpy.array([[10],
                  [20],
                  [30],
                  [40]])
...
output = DistinguishedArrayChooser(data,data2,data3, moleculesLikelihood, sensitivityValues)
#print(output)
