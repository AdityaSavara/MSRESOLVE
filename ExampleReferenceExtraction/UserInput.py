...
UserChoices['inputFiles']['referenceFileNamesList'] = ['ExistingReferencePatterns.csv'] #enter the file name of the file containing reference information
...
UserChoices['measuredReferenceYorN']['referenceFileToTune'] =['ReferenceCollected.csv','xyyy']
UserChoices['measuredReferenceYorN']['referenceFileToMatch'] =['ReferenceLiterature.csv','xyyy']
