...
__var_list__ = ['referenceFileName','form','collectedFileName','iterativeAnalyis','preProcessing','dataAnalysis','dataSimulation','grapher','timeRangeLimit','timeRangeStart','timeRangeFinish',
