...
UserChoices['measuredReferenceYorN']['tuningCorrectPatternInternalVsExternal'] = 'External' #the options are 'External' or 'Internal'.  As of Nov 2021, the only time that 'Internal' should be used is when applying reference Coefficients manually to the Reference Analysis pattern.
