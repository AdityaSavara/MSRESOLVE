...
UserChoices['measuredReferenceYorN']['referenceFileToTune'] =['ReferenceCollected.csv','xyyy'] #This is the pattern that will be changed.
UserChoices['measuredReferenceYorN']['referenceFileToMatch'] =['ReferenceLiterature.csv','xyyy'] #This is what the pattern will look more like after everything is done.
